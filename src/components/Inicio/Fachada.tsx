...
export class Fachada extends Component {
    render() {
        return (
            <section className="section section-fachada section-tramado" id="section-fase-5">
                <div className="p-relative">
                    ...
                    <div className="contain-fachada">
                        <img className="img-bottom" src={require("Assets/images/inicio/background-botton.png")} alt='icon' loading='lazy'></img>
                        <div className="row h-100 flex-reverse">
                            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 h-100 d-flex justify-content-center align-items-center flex-column">
                                ...
                                >
                                    ...
                                    <span translate="no" 
                                        className="geomanist-light title"
                                    >
                                ...
                                >
                                    ...
                                    >
                                        Vive en <span className="geomanist-bold">Jesus María</span>, vive al<br/> frente del <span className="geomanist-bold">Campo de Marte</span> 
                                    </span>
                                </div>
                            </div>
                            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 h-100 d-flex justify-content-center align-items-center contain-img-fachada">
                                <div
                                    className="img img-contain w-100 h-100 img-fachada" 
                                    style={{backgroundImage:`url(${require("Assets/images/inicio/compress-render.webp")})`}} 
                                />
                            </div>
                        </div>
                    </div>
