...
export class Atributos extends Component {
    render() {
        return (
            <section className="section section-atributos" id="Atributos" style={{
                    ...
                    <div className="contain">
                        <div className="contentImgTitle">
                            <div className="imgtitle text-center d-flex justify-content-center align-items-center text-white" title="Nuestros atributos" >
                                ...
                                <span translate="no" className="geomanist-light fsize-1-5vw" style={{lineHeight:'1em'}}>Nuestros 
                                    <br />
                ...
                <div 
                    ...
                    style={{backgroundImage:`url(${require("Assets/images/atributos/bottom-atributos.png")})`}} 
                />
            </section>
        )
    }
